    ...
    @section('main')
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="/price_up">Sắp xếp theo giá tăng dần</a></li>
              <li><a class="dropdown-item" href="/price_down">Sắp xếp theo giá giảm dần</a></li>
            </ul>
          </div>
        <div class="container">
                            ...
                            <div class="w-100 d-flex flex-column text-start ps-4">
                                ...
                                <form action="{{URL::to('/add-cart')}}" method="post">
                                  {{csrf_field()}}
                                    ...
                                    <input type="hidden" name="product_id" value="{{$item->SP_MA}}" class="col-4">
